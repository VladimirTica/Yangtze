    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhishedProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhishedProduct_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WhishedProduct_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhishedProduct_ProductId",
                table: "WhishedProduct",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_WhishedProduct_UserId",
                table: "WhishedProduct",
                column: "UserId");
        }
